...
const { LunarResponse } = require('../core/LunarResponse');
...
router.use((req, res, next) => {
    res.sendLunarResponse = LunarResponse;
    res.sendLunarResponse.bind(res);
    next();
});
...
router.get('/', (req, res) => {
    ...
    res.sendLunarResponse({ message: 'API Running' });
